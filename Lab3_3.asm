...
program:
    ...
    div diez        ; divido entre 10 para tener en ah el residuo y en al el cociente
    
    mov bl, ah      ; guardo el residuo
    add bl, 30h     ; se suman 30 por la tabla ascii, asi imprime el caracter del numero
